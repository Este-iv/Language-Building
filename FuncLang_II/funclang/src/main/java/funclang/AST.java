...
public interface AST {
	...
	public static class LambdaExp extends Exp {		
		...
		public LambdaExp(List<String> formals, Exp body, TmpExp temp) {
			_formals = formals;
			_body = body;
			_t = temp;
		}
	...
	public static class TmpExp extends Exp {
		String holder;
		Exp v1;
		public TmpExp(String holder, Exp v1){
			this.holder= holder;
			this.v1=v1;
		}
	...
	public interface Visitor <T> {
		...
		public T visit(AST.TmpExp e, Env env);
